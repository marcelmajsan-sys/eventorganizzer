...
export const PROJECTS: Record<ProjectId, {
  ...
  "2025": {
    ...
    url: process.env.NEXT_PUBLIC_SUPABASE_URL_2025 ?? process.env.NEXT_PUBLIC_SUPABASE_URL!,
    anonKey: process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY_2025 ?? process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY!,
