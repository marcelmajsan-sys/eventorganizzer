...
import { Gift, CheckSquare, Calendar, LogOut, Building2, Menu, X } from "lucide-react";
...
const navItems = [
  ...
  { href: "/portal/tasks", label: "Zadaci", icon: CheckSquare },
  { href: "/portal/calendar", label: "Rokovnik", icon: Calendar },
];
